...
const AssetSchema = z.object({
  ...
  goalsPace: z.number().nullish(),
  assistsPace: z.number().nullish(),
  ...
  hdFinishingDelta: z.number().nullish(),
  edgeSpeedMaxMph: z.number().nullish(),
  edgeBurstsOver20: z.number().nullish(),
