...
// figure in the total), added UPS on top of AGE which already contained it,
// and showed none of the multiplicative steps.
function NavBreakdown({ nav }: { nav: XNAVResult }) {
