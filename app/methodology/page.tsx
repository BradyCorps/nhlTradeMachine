...
const SECTIONS: { id: string; title: string; paras: string[] }[] = [
  ...
  },
  {
    ...
    paras: [
      ...
      "Territorial Gravity v4 is a separate 5v5 expected-goal contract and diagnostic path. In v4 output, positive wells and domes represent estimated expected-goal impact in each phase of play. It will remain display-only and behind a disabled feature flag until an authorized event/shift dataset supports fitting, uncertainty intervals, held-out validation, and season-specific calibration. It does not currently affect X-NAV.",
    ],
  },
  {
    id: "strand",
