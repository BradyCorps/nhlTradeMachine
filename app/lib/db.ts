...
export const TEAMS_DB = [
  ...
  },
  {
    ...
    phase: 'Contender',
    needs: [
      { pos: 'C', minWar: 2.0, label: 'Top 6 C' },
      { pos: 'D', minWar: 2.0, label: 'Top 4 D' },
    ],
  },
];
...
// ============================================================
export const FINANCIALS_DB: Record<
  string,
  {
    capHit: number;
...
> = {
  ...
  'Connor McDavid': {
    ...
    yearsRemaining: 2,
    hasNMC: true,
    intangibleMultiplier: 1.2,
  },
  'Leon Draisaitl': {
    capHit: 14.0,
    yearsRemaining: 7,
    hasNMC: true,
    intangibleMultiplier: 1.1,
  },
  'Nathan MacKinnon': {
    capHit: 12.6,
    yearsRemaining: 6,
    hasNMC: true,
    intangibleMultiplier: 1.15,
  },
  'Auston Matthews': {
    capHit: 13.25,
    yearsRemaining: 3,
    hasNMC: true,
    intangibleMultiplier: 1.12,
  },
  'Cale Makar': {
    capHit: 9.0,
    yearsRemaining: 3,
  ...
  'David Pastrnak': {
    ...
    yearsRemaining: 4,
    hasNMC: true,
    intangibleMultiplier: 1.08,
  },
  'Mitch Marner': {
    capHit: 12.0,
    yearsRemaining: 5,
    hasNMC: true,
    intangibleMultiplier: 1.06,
  },
  'Nikita Kucherov': {
    capHit: 9.5,
    yearsRemaining: 3,
  ...
  'Roope Hintz': {
    ...
    yearsRemaining: 6,
    hasNTC: true,
    intangibleMultiplier: 1.03,
  },
  'Connor Bedard': {
    capHit: 14.0,
    yearsRemaining: 7,
    intangibleMultiplier: 1.25,
  },
  'Tim Stutzle': {
    capHit: 8.35,
    yearsRemaining: 6,
