...
- [x] **TM5 — GM Audit:** expand contextual reasoning using team needs, trajectory, timeline, roster redundancy, and the calibre/role of assets both ways. Example to test: receiving a franchise goalie plus second-line defenceman can justify moving a franchise defenceman; the current Bruins/McAvoy decision rejects solely because McAvoy cannot be lost, without adequately reasoning about goalie context (including Swayman). ![trade](assets/13-mcavoy-trade.png) ![audit](assets/14-mcavoy-audit.png)
- [x] **TM6 — Goalie value/team fit:** confirm a franchise goalie improves EWA and that fit flags are coherent. Test Jets–Ducks Hellebuyck for Hinds + Gauthier; determine whether both the decision and flags make sense. ![goalie trade result](assets/15-goalie-trade-result.png)
- [x] **TM7 — Landing/accessibility:** rework “Build. Audit. Share.” and remove its Open Armchair GM CTA. Make the page AA.
