...
render_square \
  "$svg_dir/cap-and-crease-mark-primary-clean.svg" \
  "$png_dir/cap-and-crease-mark-primary-clean-1024.png" \
  1024

render_square \
  "$svg_dir/cap-and-crease-mark-primary-no-puck.svg" \
  "$png_dir/cap-and-crease-mark-primary-no-puck-512.png" \
  512
...
inkscape "$svg_dir/cap-and-crease-mark-tight-horizontal.svg" \
  --export-filename="$png_dir/cap-and-crease-mark-tight-horizontal-1200.png" \
  --export-width=1200
...
render_square \
  "$svg_dir/cap-and-crease-social-avatar.svg" \
