...
//
//   npx tsx scripts/gravity-v4/bootstrap-estimates.ts            # 40 replicates
//   npx tsx scripts/gravity-v4/bootstrap-estimates.ts --boot 100 # tighter, slower
//
...
function main() {
  ...
  console.log(`\nGravity v4 — bootstrap-estimates · season ${season} · λ=${lambda} · ${nBoot} replicates`);
  ...
  console.log(`\n── TOP 15 OZ WELL — point [95% CI]  (± = bootstrap SE) `.padEnd(64, "─"));
  ...
  console.log(`\n  wrote data/gravity-v4/oz-bootstrap-${season}.json`);
